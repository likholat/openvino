                        ...
                        new Runnable() {
                            ...
                            public void run() {
                                try {
                                    ...
                                    String inputName =
                                            new ArrayList<String>(inputsInfo.keySet()).get(0);
                                    ...
                                    outputName =
                                            new ArrayList<String>(net.getOutputsInfo().keySet())
                                                    .get(0);
                                    ...
                                    while (captureThread.isAlive() || !framesQueue.isEmpty()) {
                                        ...
                                        for (int i = 0; i < inferRequestsSize; i++) {
                                            ...
                                            // and we can create Blob object using Mat object data
                                            // address.
        ...
        try {
            while (inferThread.isAlive() || !detectionOutput.isEmpty()) {
                ...
                for (int curProposal = 0; curProposal < maxProposalCount; curProposal++) {
                    ...
                    Imgproc.rectangle(img, min, max, color, 2);
                }
